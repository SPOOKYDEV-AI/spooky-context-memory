...
## 0.1 — Public MVP — released

- hierarchical memory tree;
- typed graph links;
- BFS, DFS and best-first retrieval;
- path allow/deny policies;
...
Stable API, persistent adapters, benchmark report, agent integrations, private-data guidance, and production safeguards.
